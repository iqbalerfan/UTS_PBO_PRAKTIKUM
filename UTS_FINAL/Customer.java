...
public class Customer implements UserManager {
    private String nama;
    private Reservasi reservasi; // Hanya satu reservasi untuk kesederhanaan

    public Customer(String nama) {
        this.nama = nama;
        this.reservasi = null; // Belum ada reservasi
    }
    ...
    public void buatReservasi(Kamar kamar) {
        if (kamar.isTersedia()) {
            ...
            System.out.println("Reservasi berhasil untuk Kamar Nomor: " + kamar.getNomorKamar());
        } else {
